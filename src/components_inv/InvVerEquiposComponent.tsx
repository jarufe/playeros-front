...
import { getEquipamientoProvinciaActivaPaging } from '../services/apiEquipamientoService.ts';
...
export const InvVerEquiposComponent = () => {
    ...
    useEffect(() => {
        ...
        const response = getEquipamientoProvinciaActivaPaging(user, page, rowsPerPage)
